...
--------------------------------------------
Used a Wemos D1 Mini Pro, similar boards should also work. Relays are controlled directly by GPIO pins. The pins are
set to HIGH when the station is active.
